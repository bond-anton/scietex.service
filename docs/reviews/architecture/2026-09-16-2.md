...
regression test in `tests/test_utils_config.py`. The remaining findings
(AR-088, AR-089, AR-091..AR-099) are open.

Succeeded: 3 findings (AR-086, AR-087, AR-090). Failed: 0. Skipped: 0.
