...
`None`, while the log-and-never-raise behavior is preserved. The remaining
findings (AR-089, AR-093, AR-095..AR-099) are open.

Succeeded: 7 findings (AR-086, AR-087, AR-088, AR-090, AR-091, AR-092, AR-094). Failed: 0. Skipped: 0.
