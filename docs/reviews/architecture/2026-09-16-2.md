...
becoming a plausible-but-wrong entry. AR-096 was addressed in commit `1a94485`: the `<= 0` "unbounded" convention moved out of the generic `validate_range` helper into `TaskProcessorConfig.__post_init__`, and the `unbounded_ok` flag was removed. The remaining findings (AR-089, AR-093,
AR-097..AR-099) are open.

Succeeded: 9 findings (AR-086, AR-087, AR-088, AR-090, AR-091, AR-092, AR-094, AR-095, AR-096). Failed: 0. Skipped: 0.
