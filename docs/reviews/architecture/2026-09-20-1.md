...
|---|---|---|---|---|---|
| AR-123 | Control-plane commands not routed across a multi-worker fleet | MEDIUM | Cancel silently no-ops on the wrong worker; config reaches one worker | Low (document) / High (route) | 3 |
